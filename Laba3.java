...
class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        MainTable.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[]{
                        "first num", "second num", "step", "result"
                }
        ) {
    ...
    private void LowerThresholdActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
    }

    private void UpperThresholdActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
    }
    ...
    private void AddButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String c = null;
        try{
            a = UpperThreshold.getText();
            b = LowerThreshold.getText();
            c = Step.getText();

            if ("".equals(a) || "".equals(b) || "".equals(c)){
                throw new Exc("empty field");
            } else if ("0".equals(a) || "0".equals(b) || "0".equals(c)) {
                throw new Exc("error");
            } else if (Float.parseFloat(a) > Float.parseFloat(b)){
                throw new Exc("error");
            } else if (Float.parseFloat(c) > (Float.parseFloat(b) - Float.parseFloat(a))) {
                throw new Exc("error");
            } else if (Float.parseFloat(a) < 0.000001 || Float.parseFloat(b) < 0.000001) {
                throw new Exc("error");
            } else if (Float.parseFloat(a) > 1000000 || Float.parseFloat(b) > 1000000) {
                throw new Exc("error");
            }
